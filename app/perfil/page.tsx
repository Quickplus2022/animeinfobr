...
export const metadata: Metadata = {
  ...
  description: "Seus favoritos, lista de assistir depois e preferencias de anime.",
};
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="flex items-center gap-5 mb-10 p-6 rounded-2xl bg-[#0d1424] border border-white/8">
        ...
        <div>
          <h1 className="text-2xl font-black text-white">{session.user.name || "Otaku"}</h1>
      ...
      {activeTab === "likes" ? (
        ...
        <div className="text-center py-16 text-slate-500">
          ...
          <p className="text-sm mt-1">
            {activeTab === "favorites" ? "Favorite animes nas paginas de detalhes." : "Salve animes para assistir depois."}
          </p>
